...
//static int can_update_spt(int sampl_pt, unsigned int tseg, int *tseg1, int *tseg2);
...
static int can_update_spt(int sampl_pt, unsigned int tseg, unsigned int *tseg1, unsigned int *tseg2)
{
...
uint32_t CAN_SetBaudRate(CAN_T *tCAN, uint32_t u32BaudRate)
{
    ...
    unsigned int best_tseg = 0, best_brp = 0, brp = 0;
    unsigned int tsegall, tseg = 0, tseg1 = 0, tseg2 = 0;
