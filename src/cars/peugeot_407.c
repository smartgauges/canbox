...
static void peugeot_407_ms_65D_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_571_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_470_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_359_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_5BF_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_635_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_3c3_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_35b_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_621_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_3E1_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_3E3_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void peugeot_407_ms_6DA_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static struct msg_desc_t peugeot_407_ms[] =
{
	...
	{ 0x470,   50, 0, 0, peugeot_407_ms_470_handler }, // Doors
	{ 0x359,  100, 0, 0, peugeot_407_ms_359_handler }, // Gear selector
	{ 0x5BF,  100, 0, 0, peugeot_407_ms_5BF_handler }, // Keys
	{ 0x635,  100, 0, 0, peugeot_407_ms_635_handler }, // Illum
	{ 0x3c3,  100, 0, 0, peugeot_407_ms_3c3_handler }, // Wheel
	{ 0x35b,  100, 0, 0, peugeot_407_ms_35b_handler }, // Taho
	{ 0x621,  100, 0, 0, peugeot_407_ms_621_handler }, // Break
	{ 0x6DA,   50, 0, 0, peugeot_407_ms_6DA_handler }, // Parks
	{ 0x3E1,  500, 0, 0, peugeot_407_ms_3E1_handler }, // AC
	{ 0x3E3,  500, 0, 0, peugeot_407_ms_3E3_handler }, // Seat heating
};
